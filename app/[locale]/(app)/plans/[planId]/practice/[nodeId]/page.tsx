/**
 * PRACTICE stage page: same chat shape as LEARN, but stage='practice'.
 * "Mark complete" calls markNodeStage (practice -> practiced).
 */
...
export default async function PracticeNodePage({
  ...
  const historyRows = await db
    ...
    .from(chatMessages)
    .where(and(eq(chatMessages.planId, planId), eq(chatMessages.nodeId, nodeId)))
